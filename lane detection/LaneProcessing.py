# -*- coding: utf-8 -*-
"""
Created on Tue Mar  3 20:46:44 2020
...
class Drawing:
    ...
    def addPolygon(srcShape, lFit, rFit, stepCount=10, color=(0, 255, 0)):
        ...
        xl = funcSpace(argSpace=y, fitParams=lFit)
        xr = funcSpace(argSpace=y, fitParams=rFit)
    ...
    def addLine(src, fit, color, stepCount=10, thickness=2):
        ...
        if fit is not None:
            ...
            x = funcSpace(argSpace=y, fitParams=fit)
