# -*- coding: utf-8 -*-
"""
Created on Tue Mar  3 20:44:13 2020
...
import cv2
import pickle
from utils import promptForInt
...
def main():
    dx = promptForInt('Please specify number of corners horizontally: ')
    dy = promptForInt('Please specify number of corners vertically:   ')
